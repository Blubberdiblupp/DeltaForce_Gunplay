...
class AJArmorStats
{
	static DeltaForceDisplayData GetArmorDisplay(EntityAI item)
	{
		if (!item)
		{
			return null;
	...
	static DeltaForceDisplayData GetArmorDisplayByType(string itemType)
	{
